...
execute unless score value_gamerule mpp_sleep_count > value_100 mpp_sleep_count run tellraw @a ["",{"selector":"@s"},{"text":" is now sleeping (","color":"gray"},{"score":{"name":"value_sleepers","objective":"mpp_sleep_count"}},{"text":"/","color":"gray"},{"score":{"name":"value_required","objective":"mpp_sleep_count"}},{"text":")","color":"gray"},{"text":" [Kick]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpp_sleep_kick"},"hoverEvent":{"action":"show_text","contents":[{"text":"Kick ","color":"red"},{"selector":"@a[tag=mpp_in_bed]"},{"text":" out of bed","color":"red"}]}}]

execute if score value_gamerule mpp_sleep_count > value_100 mpp_sleep_count run tellraw @a ["",{"selector":"@s"},{"text":" is now sleeping (","color":"gray"},{"text":"Sleeping disabled","color":"white","hoverEvent":{"action":"show_text","contents":[{"text":"No amount of rest can pass this night","color":"white"}]}},{"text":")","color":"gray"},{"text":" [Kick]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpp_sleep_kick"},"hoverEvent":{"action":"show_text","contents":[{"text":"Kick ","color":"red"},{"selector":"@a[tag=mpp_in_bed]"},{"text":" out of bed","color":"red"}]}}]
