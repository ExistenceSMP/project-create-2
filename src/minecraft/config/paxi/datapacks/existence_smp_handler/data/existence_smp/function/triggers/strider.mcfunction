tellraw @a [{"text":""},{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Total Strider distance","color":"#4ab8ea"}]
...
execute as @a if score @s exi_strider_km matches 1.. run tellraw @s [{"text":""},{"text":"You have ridden ","italic":true,"color":"gray"},{"score":{"name":"@s","objective":"exi_strider_km"},"italic":true,"color":"#4ab8ea"},{"text":"km on a Strider","italic":true,"color":"gray"}]
