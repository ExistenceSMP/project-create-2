tellraw @a [{"text":""},{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Total distance walked","color":"#4ab8ea"}]
...
execute as @a if score @s exi_walk_km matches 1.. run tellraw @s [{"text":""},{"text":"You have walked ","italic":true,"color":"gray"},{"score":{"name":"@s","objective":"exi_walk_km"},"italic":true,"color":"#4ab8ea"},{"text":"km","italic":true,"color":"gray"}]
