tellraw @a [{"text":""},{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Total Play time","color":"#4ab8ea"}]
...
execute as @a if score @s exi_playtime_h matches 1.. run tellraw @s [{"text":""},{"text":"You have played for ","italic":true,"color":"gray"},{"score":{"name":"@s","objective":"exi_playtime_h"},"italic":true,"color":"#4ab8ea"},{"text":" hours","italic":true,"color":"gray"}]
