tellraw @a [{"text":""},{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Total Elytra distance","color":"#4ab8ea"}]
...
execute as @a if score @s exi_elytra_km matches 1.. run tellraw @s [{"text":""},{"text":"You have flown ","italic":true,"color":"gray"},{"score":{"name":"@s","objective":"exi_elytra_km"},"italic":true,"color":"#4ab8ea"},{"text":"km with elytra","italic":true,"color":"gray"}]
