tellraw @a [{"text":""},{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Total distance crouched","color":"#4ab8ea"}]
...
execute as @a if score @s exi_crouch_km matches 1.. run tellraw @s [{"text":""},{"text":"You have crouched ","italic":true,"color":"gray"},{"score":{"name":"@s","objective":"exi_crouch_km"},"italic":true,"color":"#4ab8ea"},{"text":"km","italic":true,"color":"gray"}]
