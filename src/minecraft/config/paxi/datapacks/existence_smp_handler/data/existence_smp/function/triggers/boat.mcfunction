tellraw @a [{"text":""},{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Total Boat Distance","color":"#4ab8ea"}]
...
execute as @a if score @s exi_boat_km matches 1.. run tellraw @s [{"text":""},{"text":"You have sailed ","italic":true,"color":"gray"},{"score":{"name":"@s","objective":"exi_boat_km"},"italic":true,"color":"#4ab8ea"},{"text":"km on a Boat","italic":true,"color":"gray"}]
