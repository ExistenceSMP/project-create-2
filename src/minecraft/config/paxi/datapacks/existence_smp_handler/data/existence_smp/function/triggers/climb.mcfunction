tellraw @a [{"text":""},{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Total distance climbed","color":"#4ab8ea"}]
...
execute as @a if score @s exi_climb_km matches 1.. run tellraw @s [{"text":""},{"text":"You have climbed ","italic":true,"color":"gray"},{"score":{"name":"@s","objective":"exi_climb_km"},"italic":true,"color":"#4ab8ea"},{"text":"km","italic":true,"color":"gray"}]
